...
- If logs show `socket.gaierror: [Errno -2] Name or service not known`, Render cannot resolve the MySQL hostname. Re-copy the exact Aiven host from the service Overview and make sure the service still exists.
